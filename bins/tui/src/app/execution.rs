...
use kql_panopticon::execution::{PackExecutorConfig, PackExecutorResult, ProgressUpdate};
use kql_panopticon::{Client, Error as CoreError, Pack, PackExecutor, Workspace};
...
pub fn spawn_execution_task(
    ...
    let task_handle = tokio::spawn(async move {
        ...
        let (progress_tx, mut progress_rx) =
            kql_panopticon::execution::progress::progress_channel(job_id);
