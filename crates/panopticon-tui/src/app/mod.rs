...
use kql_panopticon_core::tracing::TuiEvent;
use kql_panopticon_core::{Client, Pack, Workspace};
...
fn format_execution_result(
    result: &kql_panopticon_core::execution::PackExecutorResult,
    inputs: &std::collections::HashMap<String, String>,
) -> String {
    use kql_panopticon_core::execution::{ExecutionPhase, ExecutionStatus, StepStatus};
    ...
    for (ws_name, ws_result) in &result.workspace_results {
        ...
        let format_step = |step: &kql_panopticon_core::execution::StepResult| -> Vec<String> {
