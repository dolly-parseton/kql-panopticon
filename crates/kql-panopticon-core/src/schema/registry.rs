    ...
    fn load_defaults(&mut self) {
        ...
        self.add_table(
            TableInfo::canonical("AADUserRiskEvents")
                .source("sentinel")
                .description("Azure AD Identity Protection risk events")
                .column(time_col.clone())
                .column(tenant_col.clone())
                .with_column("UserPrincipalName", "string")
        ...
        // AzureDiagnostics - extensible table
        self.add_table(
        ...
        self.add_table(
            TableInfo::canonical("CommonSecurityLog")
                .source("sentinel")
                .description("Common Event Format (CEF) logs")
                .column(time_col.clone())
                .column(tenant_col.clone())
                ...
                .with_column("SourcePort", "long")
                .with_column("DestinationPort", "long")
        );
        ...
        self.add_table(
            TableInfo::canonical("Heartbeat")
                .source("sentinel")
                .description("Agent heartbeat information")
                .column(time_col.clone())
                .column(tenant_col.clone())
                .with_column("Computer", "string")
        ...
        // Dummy placeholders for more tables (to be filled in later)
        for name in &[
            "AuditLogs",
            "OfficeActivity",
