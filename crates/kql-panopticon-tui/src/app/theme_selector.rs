...
impl ThemeSelectorState {
    ...
    pub fn toggle_force_black_background(&mut self) {
        self.force_black_background = !self.force_black_background;
    }

    pub fn force_black_background(&self) -> bool {
        self.force_black_background
    }
